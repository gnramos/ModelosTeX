...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	\begin{description}
		...
		\item[Mérito:]% [<o>] por que a proposta é relevante? (ex: usa abordagem
		              %       XYZ na supervisão que a torna mais acurada,
		              %       aplicação em uma massa de dados inédita)

		\item[Validação:]% [<o>] como verificar a utilidade e o mérito da
		                 %       proposta? (ex: validação cruzada e comparação
	...
	% Por exemplo, trechos ou métodos que não são claros, ou pontos que deveriam
